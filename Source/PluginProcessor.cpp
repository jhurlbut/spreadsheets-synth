...
juce::AudioProcessorValueTreeState::ParameterLayout SpreadsheetsSynthProcessor::createParameterLayout()
{
    ...
    params.push_back(std::make_unique<juce::AudioParameterFloat>("combFilterX", "Comb Filter X",
        juce::NormalisableRange<float>(0.0f, 1.0f, 0.01f), 0.5f));

    params.push_back(std::make_unique<juce::AudioParameterFloat>("combFilterY", "Comb Filter Y",
        juce::NormalisableRange<float>(0.0f, 1.0f, 0.01f), 0.5f));

    params.push_back(std::make_unique<juce::AudioParameterFloat>("combFilterMix", "Comb Filter Mix",
        juce::NormalisableRange<float>(0.0f, 1.0f, 0.01f), 0.3f));
